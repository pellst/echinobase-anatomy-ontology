...
To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/pellst/echinobase-anatomy-ontology) for details.
 ...
 * https://github.com/pellst/echinobase-anatomy-ontology/releases
 * https://github.com/pellst/echinobase-anatomy-ontology/releases/new
...
Check the build status here: [![Build Status](https://travis-ci.org/pellst/echinobase-anatomy-ontology.svg?branch=master)](https://travis-ci.org/pellst/echinobase-anatomy-ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/pellst](https://travis-ci.org/profile/pellst)
 2. click the "Sync account" button
 3. Click the tick symbol next to echinobase-anatomy-ontology
